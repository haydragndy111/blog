...
use App\Http\Controllers\Pages\SubscriptionContoller;
 ...
 * Route: subcriptions.*
*/
Route::group(['prefix' => 'subcriptions', 'as' => 'subcriptions.'], function () {
    Route::get('/cancel', [SubscriptionContoller::class, 'destroy'])->name('destroy');
});
