<aside class="min-h-screen col-span-1 px-8 bg-white shadow">
    <div class="py-6 space-y-7">
        ...
        <div>
            ...
            <div>
                <x-sidenav.link href="{{ route('admin.posts.create') }}" :active="request()->routeIs('admin.users.create')">
                    <x-zondicon-user-group class="w-3 text-theme-blue-100" />
                    <span>{{ __('Create') }}</span>
                </x-sidenav.link>
            </div>
        ...
        <div>
            ...
            {{-- <div>
                <x-sidenav.link href="{{ route('admin.writers.create') }}" :active="request()->routeIs('admin.writers.create')">
                    <x-zondicon-user-group class="w-3 text-theme-blue-100" />
                    <span>{{ __('Create') }}</span>
                </x-sidenav.link>
            </div> --}}
