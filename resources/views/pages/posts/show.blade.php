    ...
    <section class="container mx-auto">
        <div class="grid grid-cols-4 gap-10 pt-24">
            ...
            @if ($post->isPremium())
                                    ...
                                    <div class="flex items-center space-x-4">
                                        <a href="#">
                                            <img class="object-cover w-12 h-12 rounded"
                                                src="{{ asset($post->author()->profile_photo_url) }}" alt="{{ $post->author()->name() }}">
                                        </a>
                                        <div class="">
                ...
                @else
                <div class="col-span-3 p-4 shadow space-y-4" data-aos="fade-up" data-aos-duration="500">
                    <h2 class="text-xl text-theme-blue-200">
