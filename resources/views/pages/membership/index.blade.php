        ...
        <div class="grid grid-cols-3 gap-8 my-16">
            ...
            <div class="border border-gray-200 divide-y divide-gray-200 shadow-lg bg-gray-50">
                <div class="p-6">
                    ...
                    @auth
                        @notsubscribed(auth()->user())
                            <span class="block mt-6 text-theme-blue-100" >
                                {{ __('You are current sub') }}
                            </span>
                        @endnotsubscribed
                    @endauth
                ...
                <div class="border border-gray-200 divide-y divide-gray-200 shadow-lg bg-gray-50">
                    <div class="p-6">
                        ...
                        @subscribedToProduct(auth()->user(), $plan->stripeProductId(), $plan->stripeName())
                            ...
                            @onGracePeriod($plan->stripeNam())
                            @endonGracePeriod

                            {{-- Cancel Button --}}
                            <a href="{{ route('subcriptions.destroy', $plan->stripeName()) }}" class="inline-block p-2 mt-4 text-white transition-all duration-150 bg-red-600 hover:bg-red-500 " >
                                Cancel Subscription
                            </a>
                        @else
